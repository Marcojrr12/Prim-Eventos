...
<body>
  ...
  <div class="Quadrado">
   <a href="Serviços.php"><img src="Imgs/voltar.png" width="40px" style="margin-left:20px"  alt=""></a>
      <br>
      <h1 style="color:aliceblue"><img src="Imgs/descricao1.png" width="40px" alt="">    Descrição </h1> <br>
      <div class="container">
  <div class="row">
    <div class="col">
    ...
    <p>Descrição: <?php echo $result['DESCRICAO_SERVICO'] ?> </p>

   

    </div>
</div>
    <strong style="color:#029905; font-size:40px; margin-left:60px">Preço: R$<?php echo $result['PRECO_SERVICO'] ?></strong> <br><br>

<?php
  ...
  $SQL = "SELECT TITULO_SERVICO,PRECO_SERVICO,ID_SERVICO FROM SERVICO WHERE EMAIL_USER='$email'";
   ...
   <div class="wrapper d-flex align-items-stretch">
    ...
    <div class="row align-items-start">
        <?php while($mostraServico = mysqli_fetch_array($consulta)){ ?>    
          ...
          <form method="post" action="Backend/deletaServico.php">
            <button value="<?php echo "$mostraServico[2]";?>" type="submit" name="ID" style="background:none; border:none;float:right">
            <img src="Imgs/excluir.png" width ="45px"alt="">
            </button>
          </form>

          <form method="post" action="ServicoD.php" >
            <button  value="<?php echo $mostraServico[2]?>" name="servic" type="submit" style="background:none; border:none;">
            <img src="Imgs/Card.jpg" class="card-img-top" alt="..."></button>
          </form>
